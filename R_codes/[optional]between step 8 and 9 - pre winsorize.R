### Pre Winsorizing variables
{
  t <- df[,13:27]
  t <- lapply(t, Winsorize, probs = c (0.01, 0.99))
  
  df_after1 <- df
  df_after1[13:27] <- t[1:15]
...
write.csv(df_after, "pre_win_1_constructed_yearly_data_2005-2019.csv", row.names = FALSE)
