...
full_sample <- read.csv("pre_win_1_constructed_yearly_data_2005-2019.csv", stringsAsFactors = FALSE)
...
write.csv(full_sample, "pre_yearly_full_sample.csv", row.names = FALSE)
