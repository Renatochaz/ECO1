...
xtabond2 inv_at inv_atL1 SQinv_atL1 ln_pu fc_at $controle_gmm if kz_quintile==0, gmmstyle(L.(inv_atL1), lag (0 0) collapse) gmmstyle(L.(SQinv_atL1), lag (2 2) collapse)  gmmstyle(L.(fc_at), lag (2 .)) gmmstyle((cv), lag (1 .) collapse) gmmstyle(L.(d_at), lag (1 .) collapse) gmmstyle((tam), lag (0 0)) robust small twostep h(2)
...
outreg2 [Amostra_completa1 Amostra_completa2 Restritas1 Restritas2 Não_restritas1 Não_restritas2] using results8.doc, /*
...
xtabond2 inv_at inv_atL1 ln_pu fc_at $controle_gmm if kz_quintile==1, gmmstyle(L.(inv_atL1), lag (3 .) collapse) gmmstyle(L.(fc_at), lag (2 2)) gmmstyle((cv), lag (0 0) ) gmmstyle(L.(d_at), lag (1 .)collapse) gmmstyle((tam), lag (0 0) collapse) robust small twostep h(2)
xtabond2 inv_at inv_atL1 ln_pu fc_at $controle_gmm if kz_quintile==1, gmmstyle(L.(inv_atL1), lag (3 .) collapse) gmmstyle(L.(fc_at), lag (2 .)) gmmstyle((cv), lag (0 0) ) gmmstyle(L.(d_at), lag (1 .)collapse) gmmstyle((tam), lag (0 0) collapse) robust small twostep h(2)

xtabond2 inv_at inv_atL1 ln_pu fc_at $controle_gmm if kz_quintile==1, gmmstyle(L.(inv_atL1), lag (1 6) collapse) gmmstyle(L.(fc_at), lag (2 3) ) gmmstyle((cv), lag (4 4)) gmmstyle(L.(d_at), lag (1 .) collapse) gmmstyle((tam), lag (0 0) collapse) robust small twostep h(2)
